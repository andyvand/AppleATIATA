...
#ifndef _APPLEATIATAROOT_H
#define _APPLEATIATAROOT_H

#include <IOKit/IOLocks.h>
#include <IOKit/pci/IOPCIDevice.h>

class AppleATIATARoot : public IOService
{
    OSDeclareDefaultStructors( AppleATIATARoot )
