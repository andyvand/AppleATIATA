...
#ifndef _APPLEATIATACHANNEL_H
#define _APPLEATIATACHANNEL_H

#include <IOKit/IOService.h>
class AppleATIATARoot;

class AppleATIATAChannel : public IOService
{
    OSDeclareDefaultStructors( AppleATIATAChannel )

protected:
    AppleATIATARoot * fProvider;
