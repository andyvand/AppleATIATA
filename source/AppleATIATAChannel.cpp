...
OSDefineMetaClassAndStructors( AppleATIATAChannel, IOService )

//---------------------------------------------------------------------------

bool AppleATIATAChannel::mergeProperties( OSDictionary * properties )
{
    bool success = true;
...
bool AppleATIATAChannel::init( IOService *       provider,
                               ...
                               IORegistryEntry * dtEntry )
{
    ...
    fProvider = OSDynamicCast(AppleATIATARoot, provider);
    if (fProvider == 0)
        return false;
...
bool AppleATIATAChannel::handleOpen( IOService *  client,
...
void AppleATIATAChannel::handleClose( IOService *  client,
                                      IOOptionBits options )
{
...
UInt16 AppleATIATAChannel::getCommandBlockAddress( void ) const
{
    UInt16 value = 0xFFF0;
...
UInt16 AppleATIATAChannel::getControlBlockAddress( void ) const
{
    UInt16 value = 0xFFF0;
...
UInt32 AppleATIATAChannel::getInterruptVector( void ) const
{
    UInt32 value = 0xFF;
...
UInt32 AppleATIATAChannel::getChannelNumber( void ) const
{
    UInt32 value = 0xFF;
...
UInt32 AppleATIATAChannel::getUltraDMAModeMask( void ) const
{
    return fProvider->getUltraDMAModeMask();
}

UInt32 AppleATIATAChannel::getHardwareType( void ) const
{
    return fProvider->getHardwareType();
}

UInt32 AppleATIATAChannel::getHardwareFlags( void ) const
{
    return fProvider->getHardwareFlags();
}

const char * AppleATIATAChannel::getHardwareName( void ) const
{
    OSString * name;
...
void AppleATIATAChannel::pciConfigWrite8( UInt8 offset,
                                          UInt8 data,
                                          UInt8 mask )
{
...
void AppleATIATAChannel::pciConfigWrite16( UInt8  offset,
                                           UInt16 data,
                                           UInt16 mask )
{
...
void AppleATIATAChannel::pciConfigWrite32( UInt8  offset,
                                           UInt32 data,
                                           UInt32 mask )
{
...
UInt8 AppleATIATAChannel::pciConfigRead8( UInt8 offset )
{
    return fProvider->pciConfigRead8( offset );
}

UInt16 AppleATIATAChannel::pciConfigRead16( UInt8 offset )
{
    return fProvider->pciConfigRead16( offset );
}

UInt32 AppleATIATAChannel::pciConfigRead32( UInt8 offset )
{
...
bool AppleATIATAChannel::getNumberValue( const char * propKey,
                                         void       * outValue,
